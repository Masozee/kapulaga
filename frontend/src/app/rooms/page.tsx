...
const RoomsPage = () => {
  ...
  const [checkInDate, setCheckInDate] = useState('2024-08-25');
  const [checkOutDate, setCheckOutDate] = useState('2024-08-28');
  ...
  const filteredRoomTypes = MOCK_ROOM_TYPES.filter(roomType => {
