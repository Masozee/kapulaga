...
const BookingDetailPage = () => {
  ...
  useEffect(() => {
    ...
    const loadBooking = async () => {
      setLoading(true);
      // In a real app, this would be: const response = await fetch(`/api/reservations/${params.id}/`);
  ...
  const breadcrumb = [
    ...
    { label: `Booking #${booking?.reservation_number || params.id}` }
  ];
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-4">
                      <div>
                        ...
                        <p className="text-gray-900 font-bold text-lg">{booking.guest_details.full_name}</p>
                      </div>
                      <div className="flex items-center space-x-2">
                        <Mail className="h-4 w-4 text-gray-500" />
                        <span className="text-gray-700">{booking.guest_details.email}</span>
                      </div>
                      <div className="flex items-center space-x-2">
                        <Phone className="h-4 w-4 text-gray-500" />
                        <span className="text-gray-700">{booking.guest_details.phone}</span>
                      </div>
                      <div className="flex items-center space-x-2">
                        <MapPin className="h-4 w-4 text-gray-500" />
                        <span className="text-gray-700">{booking.guest_details.nationality}</span>
                      </div>
                    </div>
                    <div className="space-y-4">
                      <div>
                        <label className="text-sm font-medium text-gray-600">Address</label>
                        <p className="text-gray-900">{booking.guest_details.address}</p>
                      </div>
                      <div>
                        <label className="text-sm font-medium text-gray-600">ID Document</label>
                        <p className="text-gray-900">{booking.guest_details.id_type}: {booking.guest_details.id_number}</p>
                      </div>
                      <div>
                        <label className="text-sm font-medium text-gray-600">Date of Birth</label>
                        <p className="text-gray-900">{formatDate(booking.guest_details.date_of_birth)}</p>
                      </div>
                      <div>
                        <label className="text-sm font-medium text-gray-600">Gender</label>
                        <p className="text-gray-900">{booking.guest_details.gender}</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-6 pt-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <p className="text-gray-900 font-bold">{booking.guest_details.emergency_contact_name}</p>
                    </div>
                    <div>
                      <label className="text-sm font-medium text-gray-600">Phone</label>
                      <p className="text-gray-900 font-bold">{booking.guest_details.emergency_contact_phone}</p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <div className="space-y-1">
                        {booking.guest_details.preferences.map((preference, index) => (
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-x-6 gap-y-3">
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          <p className="font-bold text-gray-900">{formatDate(booking.check_in_date)}</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          <p className="font-bold text-gray-900">{formatDate(booking.check_out_date)}</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          <p className="font-bold text-[#005357]">{booking.nights} nights</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          <p className="font-bold text-gray-900">{booking.adults + booking.children} total</p>
                          <p className="text-xs text-gray-500">{booking.adults} adults, {booking.children} child</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-x-6 gap-y-3 mt-4 pt-4 border-t border-gray-100">
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          <p className="font-bold text-gray-900">{booking.booking_source}</p>
                        </div>
                      </div>
                      ...
                      {booking.loyalty_program && (
                        <div className="md:col-span-2 flex items-start space-x-3">
                          ...
                          <div>
                            <p className="text-xs text-gray-500 font-medium">{booking.loyalty_program.program_name}</p>
                            <div className="flex items-center space-x-2">
                      ...
                      <div key={room.id}>
                        ...
                        <div className="flex items-center justify-between mb-3">
                          ...
                          <div className="text-right">
                            <p className="font-bold text-[#005357] text-lg">{formatCurrency(room.rate)}<span className="text-sm text-gray-600 font-normal">/night</span></p>
                            <p className="text-xs text-gray-500">Total: {formatCurrency(room.total_amount)}</p>
                          </div>
                        </div>
                    ...
                    <div className="bg-yellow-50 shadow rounded p-4">
                      <div className="flex items-start space-x-3">
                        ...
                        <div className="flex-1">
                          <h4 className="font-bold text-gray-900 mb-1">Important Staff Notes</h4>
                          <p className="text-gray-800 text-sm">{booking.booking_notes}</p>
                        </div>
                      </div>
                    </div>
                  )}
                ...
                <div className="bg-white shadow">
                  ...
                  <div className="p-4 bg-gray-50 space-y-2">
                    {booking.transportation.map((transport, index) => (
                      <div key={index} className="bg-white p-3 text-sm">
                        <div className="flex items-center justify-between mb-1">
                          ...
                          <p className="font-bold text-[#005357]">{formatCurrency(transport.cost)}</p>
                        </div>
                        <p className="text-xs text-gray-600 mb-1">{transport.details}</p>
                        {transport.pickup_time && (
                          <p className="text-xs text-gray-500">Pickup: {formatDateTime(transport.pickup_time)}</p>
                        )}
                        {transport.drop_off_time && (
                          <p className="text-xs text-gray-500">Drop-off: {formatDateTime(transport.drop_off_time)}</p>
                        )}
                      </div>
                    ))}
                  </div>
                ...
                <div className="bg-white shadow">
                  ...
                  <div className="p-4 bg-gray-50 space-y-2">
                    {booking.extras.map((extra) => (
                      <div key={extra.id} className="bg-white p-3 text-sm flex items-center justify-between">
                        <div className="flex-1">
                        ...
                        <div className="text-right">
                          <p className="font-bold text-[#005357] text-sm">
                ...
                {booking.special_requests.length > 0 ? (
                  <div className="space-y-2">
                    {booking.special_requests.map((request) => (
                      <div key={request.id} className="bg-white p-3 shadow text-sm">
                        <div className="flex items-center justify-between mb-1">
                          <div className="flex items-center space-x-2">
                        ...
                        <p className="text-gray-900 font-bold mb-1">{request.description}</p>
                        {request.notes && (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="bg-white p-3 text-sm space-y-2">
                    <div className="flex justify-between">
                      <span className="text-gray-600">Room ({booking.nights} nights)</span>
                      <span className="text-gray-900">{formatCurrency(booking.rooms[0]?.total_amount || 0)}</span>
                    </div>
                    <div className="flex justify-between">
                    ...
                    <div className="pt-2">
                      <div className="flex justify-between font-bold">
                        ...
                        <span className="text-[#005357]">{formatCurrency(booking.total_amount)}</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white p-3 text-sm space-y-2">
                    <div className="flex justify-between">
                      ...
                      <span className="text-green-600 font-medium">{formatCurrency(booking.deposit_amount)}</span>
                    </div>
                    ...
                    {booking.payment_details.length > 0 && (
                      <div className="pt-2">
                        ...
                        <div className="flex justify-between">
                          <span className="text-gray-700">{booking.payment_details[0].method}</span>
                          <span className="text-gray-900 font-medium">{formatCurrency(booking.payment_details[0].amount)}</span>
                        </div>
                        <p className="text-xs text-gray-500">{formatDateTime(booking.payment_details[0].paid_at)}</p>
                      </div>
                    )}
                  </div>
                </div>
                        ...
                        <tbody>
                          {booking.rooms.map((room) => (
                            <tr key={room.id}>
                              ...
                              <td className="border border-gray-300 p-3 text-right">${room.rate}.00</td>
                              <td className="border border-gray-300 p-3 text-right">${room.rate * booking.nights}.00</td>
                            </tr>
                          ))}
                          ...
                          {booking.transportation && booking.transportation.length > 0 && 
                            booking.transportation.map((transport, index) => (
                              <tr key={index}>
                                ...
                                <td className="border border-gray-300 p-3 text-right">${transport.cost}.00</td>
                                <td className="border border-gray-300 p-3 text-right">${transport.cost}.00</td>
                              </tr>
                            ))
                          }
                          ...
                          {booking.extras && booking.extras.length > 0 && (
                            booking.extras.map((extra, index) => (
                              <tr key={index}>
                                ...
                                <td className="border border-gray-300 p-3 text-right">${extra.unit_price}.00</td>
                                <td className="border border-gray-300 p-3 text-right">${extra.total_price}.00</td>
                              </tr>
                            ))
                          )}
                          ...
                          <tr>
                            ...
                            <td className="border border-gray-300 p-3 text-right font-medium">${booking.total_amount - Math.floor(booking.total_amount * 0.1)}.00</td>
                          </tr>
                          
                          {/* Taxes */}
                          <tr>
                            <td colSpan={3} className="border border-gray-300 p-3 text-right">Tax (10%):</td>
                            <td className="border border-gray-300 p-3 text-right">${Math.floor(booking.total_amount * 0.1)}.00</td>
                          </tr>
                          
                          {/* Total */}
                          <tr className="bg-gray-50">
                            <td colSpan={3} className="border border-gray-300 p-3 text-right font-bold text-lg">Total Amount:</td>
                            <td className="border border-gray-300 p-3 text-right font-bold text-lg text-[#005357]">${booking.total_amount}.00</td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
