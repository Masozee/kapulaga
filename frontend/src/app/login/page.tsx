          ...
          <div>
            ...
            <div className="mt-6 p-4 bg-blue-50 border border-blue-200">
              ...
              <div className="space-y-1 text-xs text-blue-800">
                <div><strong>Manager:</strong> manager@kapulaga.com / manager123</div>
                <div><strong>Reception:</strong> reception@kapulaga.com / reception123</div>
                <div><strong>Housekeeping:</strong> housekeeping@kapulaga.com / house123</div>
              </div>
            </div>
          </div>
        </div>
